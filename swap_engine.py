...
class SwapEngine:
    ...
    def __init__(self, private_key, owner_address, owner_private_key):
        """
        Args:
            private_key: User's private key
            owner_address: Bot owner's wallet address
            owner_private_key: Bot owner's private key (for fee collection)
        """
    ...
    def swap_hype_for_token(self, token_address, hype_amount):
        """
        Swap HYPE for token and collect 0.005 HYPE fee
        ...
        try:
            ...
            fee_wei = Web3.to_wei(0.005, 'ether')  # 0.005 HYPE fee
            ...
            logger.info(f"Fee sent: {fee_tx['tx_hash']}")
    ...
    def _execute_swap(self, token_address, hype_amount):
        ...
        try:
            ...
            # In production, integrate with actual DEX API
            return {
                "success": True,
                "tx_hash": "0x" + "a" * 64,
